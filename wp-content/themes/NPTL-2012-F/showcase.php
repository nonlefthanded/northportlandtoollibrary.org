		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<div class="featured-posts">
					<h1 class="showcase-heading"><?php _e( 'Featured Post'); ?></h1>
				...
				<?php endif; ?>
					...
					<?php
						...
						if ( has_post_thumbnail() ) {
							if ( $image[1] >= HEADER_IMAGE_WIDTH ) { ?>
								<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"> <?php the_post_thumbnail( 'large-feature' ); ?></a>
							<?php } else { ?>
								<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail( 'small-feature' ); ?></a>
							<?php }
						}
					?>
				...
				<nav class="feature-slider">
					...
					<?php
				    	...
				    	while ( $featured->have_posts() ) : $featured->the_post();
				    		$counter_slider++;
				    ?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php printf( esc_attr__( 'Featuring: %s'), the_title_attribute( 'echo=0' ) ); ?>" <?php
						if ( 1 == $counter_slider ) :
							echo 'class="active"';
						endif;
						?>></a></li>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts'); ?></h1>
						...
						if ( 1 == $counter ) :
							...
							<li class="entry-title">
								...
								<span class="comments-link">
									<?php comments_popup_link( __( '<span class="leave-reply">Leave a reply</span>'), __( '<b>1</b> Reply'), __( '<b>%</b> Replies') ); ?>
								</span>
							</li>
