...
<!-- Navigation -->
 ...
 <li >
	...
	<li >
        ...
        <li class="active"><a href="<?php bloginfo('url'); ?>/get-involved/" title="<?php _e('Get Involved'); ?>"><?php if($pages_title==="" || !$pages_title) { _e('Get Involved'); } else { echo $pages_title; } ?></a></li>
