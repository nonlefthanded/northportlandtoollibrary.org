...
class Themeisle_Customizer_Notify {
	...
	public function setup_config() {
		...
		$this->recommended_actions_title = isset( $this->config['recommended_actions_title'] ) ? $this->config['recommended_actions_title'] : 'subsimple';
		$this->recommended_plugins_title = isset( $this->config['recommended_plugins_title'] ) ? $this->config['recommended_plugins_title'] : 'subsimple';
		$this->dismiss_button = isset( $this->config['dismiss_button'] ) ? $this->config['dismiss_button'] : 'subsimple';
		...
		$install_button_label = isset( $this->config['install_button_label'] ) ? $this->config['install_button_label'] : 'subsimple';
		$activate_button_label = isset( $this->config['activate_button_label'] ) ? $this->config['activate_button_label'] : 'subsimple';
		$deactivate_button_label = isset( $this->config['deactivate_button_label'] ) ? $this->config['deactivate_button_label'] : 'subsimple';
	...
	public function themeisle_customizer_notify_scripts_for_customizer() {
		...
		wp_localize_script(
			'ti-customizer-notify-customizer-js', 'tiCustomizerNotifyObject', array(
				...
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'subsimple' ),
			)
		);
