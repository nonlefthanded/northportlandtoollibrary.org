...
class Themeisle_Customizer_Notify_Section extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $recommended_actions = 'subsimple';
	/**
	 * Recommended Plugins.
	 *
	 * @var string
	 */
	public $recommended_plugins = 'subsimple';
	/**
	 * Total number of required actions.
	 *
	 * @var string
	 */
	public $total_actions = 'subsimple';
	/**
	 * Plugin text.
	 *
	 * @var string
	 */
	public $plugin_text = 'subsimple';
	/**
	 * Dismiss button.
	 *
	 * @var string
	 */
	public $dismiss_button = 'subsimple';
	...
	public function json() {
		...
		foreach ( $ti_customizer_notify_recommended_actions as $key => $ti_customizer_notify_recommended_action ) {
			...
			if ( isset( $ti_customizer_notify_recommended_action['plugin_slug'] ) ) {
				...
				if ( $active['needs'] !== 'install' && $active['status'] ) {
					...
					$ti_customizer_notify_recommended_action['class'] = 'subsimple';
				}
		...
		foreach ( $ti_customizer_notify_recommended_plugins as $slug => $plugin_opt ) {
			...
			if ( $active['needs'] !== 'install' && $active['status'] ) {
				...
				$ti_customizer_notify_recommended_plugin['class'] = 'subsimple';
			}
